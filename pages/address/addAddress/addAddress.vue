<template>
  <view class="wrap">
    <view class="input-area">
      <view class="attr-area"
        ...
        <input class="input"
               @input="getInfo"
               data-type="name"
               placeholder="수취인 의 성명 을 기입 해 주 십시오"
               placeholder-style="color:#DAE0E3;" />
      </view>
      ...
      <view class="attr-area attr-tips"
            v-else>
        <view class="attr-area-tips">
          <text class="attr-name">收件人：</text>
          <input class="input"
                 @input="getInfo"
                 data-type="name"
        ...
        <view class="tips">收件人名称必须与身份证姓名相符，否则无法清关</view>
      </view>
      <view class="attr-area"
            v-if="language == 2">
        ...
        <input type="number"
               ...
               @input="getInfo"
               data-type="phone"
               placeholder="수취인 의 휴대 전화 번 호 를 기입 해 주 십시오"
               placeholder-style="color:#DAE0E3;" />
      </view>
      <view class="attr-area"
            v-else>
      ...
      <view class="picker-area space-between attr-area"
            v-if="language == 2">
      ...
      <view class="address-detail attr-area"
            v-if="language == 2">
        <text class="attr-name">상세 주소：</text>
        <input type="text"
               @input="getInfo"
               data-type="address-detail"
               placeholder="거리"
               placeholder-style="color:#DAE0E3;" />
      </view>
      <view class="address-detail attr-area"
      ...
      <view class="user_identify attr-area"
            v-if="language != 2">
    ...
    <view class="alert-tip">
      <view class="tip">
        <text class="iconfont icon-fuxuankuang_xuanzhong"
              style="color: #57D0D9;"
              v-if="isshow"
              @click="show"></text>
        <text class="iconfont icon-fuxuankuang_weixuanzhong"
              v-else
              @click="show"></text>
