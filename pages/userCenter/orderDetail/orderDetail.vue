<template>
    <view class="detail_container" v-if="showDetail">
        ...
        <view class="detail_address">
            <view class="detail_address_top">
                <view class="address_top_left">
                    <image class="address_icon" src="../../../static/images/location.png"></image>
        ...
        <view class="detail_goods">
            <view class="goods_top">
                ...
                <view class="goods_top_time" v-if="delivery_time">{{ delivery_time }}</view>
            </view>
            <view class="goods_list">
                <view class="good_item" v-for="(item,index) in goodsList" :key="index" @click="gotoGoodDetail" :data-gid="item.gid">
                    <image class="good_item_pic" :src="base_url+item.thumb"></image>
            ...
            <view class="info_list">
                <view class="info_item">
                    ...
                    <view class="info_item_right">
                        ...
                        <view class="copy_btn"
                        @click="copy(infoDetail.order_num)"
                        >复制</view>
                    </view>
                </view>
                <view class="info_item">
                ...
                <view class="info_item" v-if="infoDetail.delivery_num">
                    <view class="info_item_title">快递单号：</view>
                    <view class="info_item_right" v-if="infoDetail.delivery_num">
                        <view class="info_item_right_text">{{ infoDetail.delivery_num }}</view>
                        <view class="copy_btn"
                        @click="copy(infoDetail.delivery_num)"
                        >复制</view>
                    </view>
                </view>
                <view class="info_item" v-if="orderStateObj.showPayMethod">
        ...
        <view class="detail_remark" v-if="remark_text">
             <view class="remark_title">订单备注</view>
             <view class="remark_text">{{ remark_text }}</view>
        </view>
        <!-- 底部按钮 -->
        <view class="bottom_wrap">
            <view class="cancel_btn detail_btn" v-if="orderStateObj.showCancelBtn" @click="cancelOrder">取消订单</view>
            <view class="cancel_btn detail_btn" v-if="orderStateObj.showRefundOrderBtn" @click="refundOrder">申请退款</view>
            <view class="cancel_btn detail_btn" v-if="orderStateObj.showDeleteOrderBtn" @click="deleteOrder">删除订单</view>
            <view class="cancel_pri detail_btn" v-if="orderStateObj.showPayBtn" @click="payOrder">立即付款</view>
...
export default {
    ...
    methods: {
        ...
        getOrderDetail(){
            tools.httpClient('home/WxStore/getOrderInfo', {'oid': this.oid}, (error, result) => {
